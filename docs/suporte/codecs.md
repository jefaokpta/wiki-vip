...
![g729faltando](../../assets/img/suporte/codecs/g729faltando.jpg "g729 faltando")
...
Nessa pasta faça o comando wget a seguir para fazer o download do <a href="/assets/img/suporte/codecs/codec_g729.so" > codec g729 </a> daqui da Wiki:

```
sudo wget http://wiki.vipsolutions.com.br/assets/img/suporte/codecs/codec_g729.so
```
...
![g729instalado](../../assets/img/suporte/codecs/g729instalado.jpg "g729 instalado")
